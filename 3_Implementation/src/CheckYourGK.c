...
int main()
    ...
    printf("\n    general knowledge. You will eligible to play the game if you give 2 correct answer");
    ...
    printf("\n    By this way you can win upto Ten Lakh cash prize!!!!!..........");
    printf("\n >> You will be given 4 options and you have to choose between A, B ,C or D");
    printf("\n >> You will be asked questions continuously, till the time you are giving right answers");
    printf("\n\n\t!!!!!!!!!!!!! ALL THE BEST !!!!!!!!!!!!!");
